...
count = 0
data_path = '/content/MoNuSAC_Testing_Data_and_Annotations'  # Path to read data from
destination_path = '/content'  # Path to save n-ary masks corresponding to xml files
os.chdir(destination_path)

try:
    os.mkdir(destination_path + '/MoNuSAC_test_masks')
except OSError:
    print("Creation of the mask directory %s failed" % destination_path)

os.chdir(destination_path + '/MoNuSAC_test_masks')  # Create folder named as MoNuSAC_masks
